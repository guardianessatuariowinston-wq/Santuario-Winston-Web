...
function winstonGuide(kindKey, prefix) {
  if (kindKey !== 'aprende') return '';
  return `<section class="winston-guide-section winston-guide-section-aprende" data-winston-guide="aprende"><div class="shell"><div class="winston-guide"><div class="winston-guide-media"><img class="winston-guide-image" src="${prefix}assets/media/mascota/winston-aprende.webp" alt="Winston, mascota guía del Santuario" width="203" height="273" decoding="async"></div><div class="winston-guide-copy"><p class="eyebrow">Hola, soy Winston</p><h2>¿Preparado para descubrir algo nuevo?</h2><p>Te acompañaré por curiosidades, preguntas, verdadero o falso y contenidos para conocer mejor a los caballos y respetar sus necesidades.</p><div class="button-row"><a class="button button-primary" href="${prefix}guardianes.html">Conocer a Winston</a></div></div></div></div></section>`;
}
