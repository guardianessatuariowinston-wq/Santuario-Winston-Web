...
function page(record, index) {
  ...
  const canonical = `https://santuariowinston.com/animales/${record.slug}/`;
  const ogImage = `https://santuariowinston.com/${record.image}`;
