...
export function mobileNav(prefix = '') {
  return `<nav aria-label="Navegación móvil">
    ...
    <div class="drawer-group"><a href="${href(prefix,'habitantes.html')}">Descubre</a><a class="drawer-child" href="${href(prefix,'habitantes.html')}">Habitantes</a><a class="drawer-child" href="${href(prefix,'guardianes.html')}">Los Guardianes</a><a class="drawer-child" href="${href(prefix,'sobre-nosotros.html')}">Nosotros</a></div>
    ...
    <div class="drawer-group"><a href="${href(prefix,'actividades.html')}">Actividades</a></div><div class="drawer-group"><a href="${href(prefix,'contacto.html')}">Contacto</a></div>
  </nav>`;
}
